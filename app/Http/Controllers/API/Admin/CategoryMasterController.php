...
class CategoryMasterController extends Controller
{
    public function index(Request $request)
    {
        try
        {
            ...
            {
                $categoryMasters = CategoryMaster::where('category_master_id',null)->simplePaginate($request->per_page_record)->appends(['per_page_record' => $request->per_page_record]);
            }
            else
            {
                $categoryMasters = CategoryMaster::where('category_master_id',null)->get();
            }
