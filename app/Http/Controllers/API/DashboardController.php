...
class DashboardController extends Controller
{
	...
	public function saleAmount(Request $request)
	{
		try{
			$data = [];
			$data['total_earnings_of_today'] = round(OrderItem::select('order_items.id')
				->join('orders', 'orders.id','=','order_items.order_id')
				->where('orders.payment_status', 'paid')
			...
			$data['total_earnings_of_week'] = round(OrderItem::select('order_items.id')
				->join('orders', 'orders.id','=','order_items.order_id')
				->where('orders.payment_status', 'paid')
			...
			$data['total_earnings_of_month'] = round(OrderItem::select('order_items.id')
				->join('orders', 'orders.id','=','order_items.order_id')
				->where('orders.payment_status', 'paid')
