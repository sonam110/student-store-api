...
class OrderItem extends Model
{
    ...
    protected $fillable = [
        'user_id','order_id','vendor_user_id','package_id','products_services_book_id','contest_application_id','product_type','contest_type','title','sku','attribute_data','price','used_item_reward_points','price_after_apply_reward_points','quantity','discount','sell_type','rent_duration','item_status','item_payment_status','amount_returned','date_of_return_initiated', 'canceled_refunded_amount','returned_rewards','date_of_return_completed','return_card_number','return_card_holder_name','reason_of_return','reason_of_cancellation','is_returned','is_replaced','is_rated','note_to_seller','cover_image','return_applicable_date','tracking_number','expected_delivery_date','delivery_completed_date','delivery_code','is_disputed','disputes_resolved_in_favour','earned_reward_points','reward_point_status','ask_for_cancellation','reason_for_cancellation_request_decline','reason_for_cancellation_request','is_sent_to_cool_company','sent_to_cool_company_date','is_transferred_to_vendor','amount_transferred_to_vendor','fund_transferred_date','student_store_commission','cool_company_commission','student_store_commission_percent','cool_company_commission_percent','vat_percent'
    ];
