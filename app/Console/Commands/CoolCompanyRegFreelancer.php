...
class CoolCompanyRegFreelancer extends Command
{
    ...
    public function handle()
    {
        ...
        $getStudentList = StudentDetail::select('users.id','users.first_name','users.last_name','users.email','users.qr_code_number','users.is_verified','users.is_email_verified','users.is_contact_number_verified','users.status','users.social_security_number','users.bank_account_num','users.bank_identifier_code','users.bank_name','users.bank_account_type')
